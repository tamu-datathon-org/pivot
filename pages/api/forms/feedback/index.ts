...
const formUrl =
  "https://docs.google.com/forms/d/e/1FAIpQLSfFWOGJ-vRrmC9qyfgeMQqJ0EK7CmO90Lw7kvMG-4OjjYh71w/viewform";
const queryParamMapping = {
  "entry.1530318392": InfoBuilderDataFields.GATEKEEPER_EMAIL,
};
...
export default async (req: NextApiRequest, res: NextApiResponse) => {
  try {
    ...
    return res.redirect(
      encodeURI(`${process.env.GATEKEEPER_URL}/login?r=${req.url}`)
    );
  }
};
